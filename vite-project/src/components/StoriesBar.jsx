...
const StoriesBar = () => {
    ...
    return (
        <div className='w-screen sm:w-[calc(100vw-200px)] lg:max-w-2xl no-scrollbar
        overflow-x-auto px-4'>
            <div className='flex gap-4 pb-5'>
                {/*Add story card*/}
                <div onClick={()=>setShowModel(true)} className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-40
              ...
              border-2 border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white'>
                ...
                {/*Story Cards*/}
                {
                    stories.map((story, index) => (
                        ...
                        min-w-30 max-h-40 cursor-pointer hover:shadow-lg
